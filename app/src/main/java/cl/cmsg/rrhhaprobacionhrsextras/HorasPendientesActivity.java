...
public class HorasPendientesActivity extends AppCompatActivity{
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		btnAprobarTodo.setOnClickListener(new View.OnClickListener(){
			...
			public void onClick(View view){
				if (!isFilasSeleccionadas()){
					Toast.makeText(getApplicationContext(), "No hay solicitudes seleccionadas", Toast.LENGTH_SHORT).show();
					return;
				}

				final SparseBooleanArray checkedItemPositions = listViewPendientes.getCheckedItemPositions();
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data){
		if (requestCode == PEND && resultCode == RESULT_OK){
				llenarLista();
	...
	void llenarLista(){
		...
		while (cursor.moveToNext()){
			...
			String tipoPacto = cursor.getString(cursor.getColumnIndex("tipoPacto"));
	...
	private Boolean isFilasSeleccionadas(){
