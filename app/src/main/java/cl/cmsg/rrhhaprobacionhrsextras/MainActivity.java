...
public class MainActivity extends AppCompatActivity{
			...
			public void onResponse(String response){
				...
				for (int i = 0; i < total; i++){
					...
					try {
						...
						centro_costo = jsonData.getString("centroCosto");
						area = jsonData.getString("area");
						tipo_pacto = jsonData.getString("tipoPacto");
	...
	public void updateList(){
		...
		String text1 = "Solicitudes Pendientes [ " + String.valueOf(miDbHelper.CuentaSolicitudes()) + " ]";
		btnSolPendientes.setText(text1);

		//Actualizar Errores
		String text = "Enviar Errores [ " + String.valueOf(miDbHelper.CuentaErrores()) + " ]";
		btnError.setText(text);

		//Actualizar Version
		String text2 = "Version: " + getString(R.string.version);
		btnVersion.setText(text2);
	...
	private class DownloadTask extends AsyncTask<String, Integer, String>{
		...
		protected void onPreExecute(){
			...
			// presses the power button Ok during download
...
//    Si es distinto de Null significa que trae un mensajeERROR de error.
				...
				miDbHelper.insertarLogError("MainActivity DownloadTask onPostExecute :" + result, mac);
				return;
			}
